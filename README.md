...
```sh
# 1. Bootstrap GraphQL server in directory `extrastressed`, based on `typescript-advanced` boilerplate
graphql create extrastressed --boilerplate typescript-advanced
